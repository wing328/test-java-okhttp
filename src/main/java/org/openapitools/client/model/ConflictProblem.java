...
public class ConflictProblem extends Problem {
   ...
   */
  public ConflictProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConflictProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConflictProblem>() {
           ...
           public ConflictProblem read(JsonReader in) throws IOException {
             ...
             ConflictProblem instance = thisAdapter.fromJsonTree(jsonObj);
