...
public class GenericProblem extends Problem {
   ...
   */
  public GenericProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericProblem>() {
           ...
           public GenericProblem read(JsonReader in) throws IOException {
             ...
             GenericProblem instance = thisAdapter.fromJsonTree(jsonObj);
