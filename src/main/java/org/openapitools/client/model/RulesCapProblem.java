...
public class RulesCapProblem extends Problem {
   ...
   */
  public RulesCapProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RulesCapProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RulesCapProblem>() {
           ...
           public RulesCapProblem read(JsonReader in) throws IOException {
             ...
             RulesCapProblem instance = thisAdapter.fromJsonTree(jsonObj);
