...
public class UnsupportedAuthenticationProblem extends Problem {
   ...
   */
  public UnsupportedAuthenticationProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnsupportedAuthenticationProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UnsupportedAuthenticationProblem>() {
           ...
           public UnsupportedAuthenticationProblem read(JsonReader in) throws IOException {
             ...
             UnsupportedAuthenticationProblem instance = thisAdapter.fromJsonTree(jsonObj);
