...
public class ClientDisconnectedProblem extends Problem {
   ...
   */
  public ClientDisconnectedProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClientDisconnectedProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientDisconnectedProblem>() {
           ...
           public ClientDisconnectedProblem read(JsonReader in) throws IOException {
             ...
             ClientDisconnectedProblem instance = thisAdapter.fromJsonTree(jsonObj);
