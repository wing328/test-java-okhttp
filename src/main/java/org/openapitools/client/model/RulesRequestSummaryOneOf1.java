...
public class RulesRequestSummaryOneOf1 {
  ...
  **/
   ...
   */
  public RulesRequestSummaryOneOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleted, rulesRequestSummaryOneOf1.deleted) &&
        ...
        Objects.equals(this.additionalProperties, rulesRequestSummaryOneOf1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleted, notDeleted, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RulesRequestSummaryOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RulesRequestSummaryOneOf1>() {
           ...
           public RulesRequestSummaryOneOf1 read(JsonReader in) throws IOException {
             ...
             RulesRequestSummaryOneOf1 instance = thisAdapter.fromJsonTree(jsonObj);
