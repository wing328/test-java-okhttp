...
public class NonCompliantRulesProblem extends Problem {
   ...
   */
  public NonCompliantRulesProblem putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NonCompliantRulesProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NonCompliantRulesProblem>() {
           ...
           public NonCompliantRulesProblem read(JsonReader in) throws IOException {
             ...
             NonCompliantRulesProblem instance = thisAdapter.fromJsonTree(jsonObj);
