  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TweetCreateRequestReply.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TweetCreateRequestReply` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("exclude_reply_user_ids").isJsonArray()) {
