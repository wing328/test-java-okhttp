...
public class FakeApi {
     ...
     */
    public okhttp3.Call testQueryParameterCollectionFormatCall(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String allowEmpty, Map<String, String> language, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (allowEmpty != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("allowEmpty", allowEmpty));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call testQueryParameterCollectionFormatValidateBeforeCall(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String allowEmpty, Map<String, String> language, final ApiCallback _callback) throws ApiException {
        ...
        if (allowEmpty == null) {
            throw new ApiException("Missing the required parameter 'allowEmpty' when calling testQueryParameterCollectionFormat(Async)");
        }
        

        okhttp3.Call localVarCall = testQueryParameterCollectionFormatCall(pipe, ioutil, http, url, context, allowEmpty, language, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> testQueryParameterCollectionFormatWithHttpInfo(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String allowEmpty, Map<String, String> language) throws ApiException {
        okhttp3.Call localVarCall = testQueryParameterCollectionFormatValidateBeforeCall(pipe, ioutil, http, url, context, allowEmpty, language, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call testQueryParameterCollectionFormatAsync(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String allowEmpty, Map<String, String> language, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = testQueryParameterCollectionFormatValidateBeforeCall(pipe, ioutil, http, url, context, allowEmpty, language, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
